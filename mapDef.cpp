...
Room :: Room(Pwindow room, terminal sizet, int layout, door doorx, int id)
{
this->id = id;
this->doorx = doorx;
this->room = room;
...
void Room :: open_right_exit(){
    doorx.RightExitOpen=true;
}

coordinates Room :: getcoordinatesP() // coordinate dove spawna il player
{
    coordinates p;
    if (layout == 0)
    {
...
coordEnemy Room :: getcoordinatesE1() // coordinate dove spawna il nemico 1 // 3 possibili spawn
{
    coordEnemy e1;
    if (layout == 0)
    {
...
coordEnemy Room :: getcoordinatesE2() // coordinate dove spawna il nemico 2 // 3 possibili spawn
{
    coordEnemy e2;
    if (layout == 0) // 15,20
    {
...
coordEnemy Room :: getcoordinatesE3() // coordinate dove spawna il nemico 3 //3 possibili spawn
{
    coordEnemy e3;
    if (layout == 0) //17,60
    {
