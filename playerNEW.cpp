...
void Player :: mvup2() {        //direzioni salto con lo shift
    if (!flag2) {
...
void Player :: healtup (artifact * h, int score){        //funzioni usate per l'interazione col personaggio e per controllare
    if (h->collected(yLoc, xLoc)){                  //posso raccogliere l'artefatto
        if (score>=100){
            healt = healt + 50;
        }
        else{
